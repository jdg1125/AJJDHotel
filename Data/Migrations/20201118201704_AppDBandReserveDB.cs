...
{
    public partial class AppDBandReserveDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Beds = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    View = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    RoomName = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    Rate = table.Column<decimal>(type: "decimal", nullable: false),
                    ImgPath = table.Column<string>(type: "TEXT", maxLength: 150, nullable: false)
                },
                constraints: table =>
                {
